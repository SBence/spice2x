    ...
    if (lights.empty()) {
        ...
        GameAPI::Lights::sortLightsWithCategory(
                &lights,
                {
                    ...
                    {"Valkyrie", "Control Panel 6/24 R"},
                    {"Valkyrie", "Control Panel 6/24 G"},
                    {"Valkyrie", "Control Panel 6/24 B"},
                    {"Valkyrie", "Control Panel 12/24 R"},
                    {"Valkyrie", "Control Panel 12/24 G"},
                    {"Valkyrie", "Control Panel 12/24 B"},
                    {"Valkyrie", "Control Panel 18/24 R"},
                    {"Valkyrie", "Control Panel 18/24 G"},
                    {"Valkyrie", "Control Panel 18/24 B"},
                    {"Valkyrie", "Control Panel 24/24 R"},
                    {"Valkyrie", "Control Panel 24/24 G"},
                    {"Valkyrie", "Control Panel 24/24 B"},
