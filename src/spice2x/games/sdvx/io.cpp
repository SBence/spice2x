    ...
    if (lights.empty()) {
        ...
        GameAPI::Lights::sortLightsWithCategory(
                &lights,
                {
                    ...
                    {"Valkyrie", "Control Panel 7/94 R"},
                    {"Valkyrie", "Control Panel 7/94 G"},
                    {"Valkyrie", "Control Panel 7/94 B"},
                    {"Valkyrie", "Control Panel 27/94 R"},
                    {"Valkyrie", "Control Panel 27/94 G"},
                    {"Valkyrie", "Control Panel 27/94 B"},
                    {"Valkyrie", "Control Panel 47/94 R"},
                    {"Valkyrie", "Control Panel 47/94 G"},
                    {"Valkyrie", "Control Panel 47/94 B"},
                    {"Valkyrie", "Control Panel 67/94 R"},
                    {"Valkyrie", "Control Panel 67/94 G"},
                    {"Valkyrie", "Control Panel 67/94 B"},
                    {"Valkyrie", "Control Panel 87/94 R"},
                    {"Valkyrie", "Control Panel 87/94 G"},
                    {"Valkyrie", "Control Panel 87/94 B"},
                    {"Valkyrie", "Control Panel 94/94 R"},
                    {"Valkyrie", "Control Panel 94/94 G"},
                    {"Valkyrie", "Control Panel 94/94 B"},
