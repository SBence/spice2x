            ...
            unsigned int index, uint8_t *data)
    {
        ...
        if (tapeledutils::is_enabled() && index < std::size(mapping)) {
            ...
            if (index == 5) {
                ...
                // split into: 7 colors (0-6), 20 colors (7-26), 20 colors (27-46), 20 colors (47-66), 20 colors (67-86), 7 colors (87-93)
                struct ControlPanelMapping {
                    size_t data_size;
                    int index_r, index_g, index_b;
                } cp_mapping[] = {
                    { 7, Lights::CONTROL_PANEL_94_94_R, Lights::CONTROL_PANEL_94_94_G, Lights::CONTROL_PANEL_94_94_B },
                    { 20, Lights::CONTROL_PANEL_87_94_R, Lights::CONTROL_PANEL_87_94_G, Lights::CONTROL_PANEL_87_94_B },
                    { 20, Lights::CONTROL_PANEL_67_94_R, Lights::CONTROL_PANEL_67_94_G, Lights::CONTROL_PANEL_67_94_B },
                    { 20, Lights::CONTROL_PANEL_47_94_R, Lights::CONTROL_PANEL_47_94_G, Lights::CONTROL_PANEL_47_94_B },
                    { 20, Lights::CONTROL_PANEL_27_94_R, Lights::CONTROL_PANEL_27_94_G, Lights::CONTROL_PANEL_27_94_B },
                    { 7, Lights::CONTROL_PANEL_7_94_R, Lights::CONTROL_PANEL_7_94_G, Lights::CONTROL_PANEL_7_94_B },
                };
